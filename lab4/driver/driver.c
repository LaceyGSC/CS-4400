...
typedef struct {
  ...
  int valid;            /* The function is tested if this is non zero */
} bench_t;

/* The range of image dimensions that we will be testing */
static int test_dim_rotate[] = {128, 256, 512, 1024, 2048, 4096};
static int test_dim_smooth[] = {32, 64, 128, 256, 512, 1024};

/* Baseline CPEs (see config.h) */
static double rotate_baseline_cpes[] = {R128, R256, R512, R1024, R2048, R4096};
static double smooth_baseline_cpes[] = {S32, S64, S128, S256, S512, S1024};
